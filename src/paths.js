...
export const iosAppDelegate = ['ios/*/AppDelegate.h', 'ios/*/AppDelegate.swift'];
  ...
  return [
    ...
    },
    {
      ...
      from: [
        ...
        new RegExp(`\\bpath = ${cleanNewPathContentStr}/AppDelegate.swift\\b`, 'gi'),
      ...
      to: [
        ...
        `path = "${cleanNewPathContentStr}/AppDelegate.swift"`,
